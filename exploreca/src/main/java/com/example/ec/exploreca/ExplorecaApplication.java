package com.example.ec.exploreca;

import com.example.ec.exploreca.domain.Difficulty;
import com.example.ec.exploreca.domain.Region;
import com.example.ec.exploreca.service.TourPackageService;
import com.example.ec.exploreca.service.TourService;
...
public class ExplorecaApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(ExplorecaApplication.class, args);
	}
	...
	/**
	 * Helper class to import ExploreCanada.json
	 */
